<template>
    <div class='container'>
                    ...
                    <div v-for='(c,index) in col' :key='index' class='col item'>
                        ...
                        <div v-else class='null-computer'>
                            ...
                            <div class='operation-group'>
                                <el-button type='primary' @click='assignmentComputer((r - 1) * col + c)'>分配
                                </el-button>
                            </div>
        ...
        <add-computer v-if='showDialog'
                      ref='addComputerForm'
                      :selected-camera-stand='selectedCameraStand'
...
import addComputer from '@/components/page/MachineRoom/MachineRoomDetail/modules/addComputerForm.vue';
...
export default {
    ...
    methods: {
         ...
         */
        initComputerData() {
            console.log(this.machineRoom.name);
         ...
         * 分配电脑
         */
        assignmentComputer(cameraStand) {
            this.selectedCameraStand = cameraStand;
            this.showDialog = true;
            // 对话框展开
            this.$nextTick(() => {
                this.$refs['addComputerForm'].showDialog = true;
            });
        },
